...
with open(r'd:\C.Slim\ict-intelligence\smartmoneyconcepts\smc.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open(r'd:\C.Slim\ict-intelligence\smartmoneyconcepts\smc.py', 'w', encoding='utf-8') as f:
    f.write(new_content)
print("Patched.")
