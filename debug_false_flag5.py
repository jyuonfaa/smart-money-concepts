...
signals = false_flag_signals(df_daily, df_15m, daily_cons, daily_rets,
    daily_ts, daily_ob)
...
print(bull[['trap_entry','trap_stop_loss','trap_cons_top',
    'trap_cons_bottom']].to_string())
print(bear[['trap_entry','trap_stop_loss','trap_cons_top',
    'trap_cons_bottom']].to_string())
