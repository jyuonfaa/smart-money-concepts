...
def _trendline_phantoms(ohlc, swings):
    ...
    - trap_ts: The origin timestamp of the trap (used for deduplication)
...
print("smc.py rewritten with trap_ts consumption logic successfully.")
